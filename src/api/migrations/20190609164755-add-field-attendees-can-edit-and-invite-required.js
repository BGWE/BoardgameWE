...
module.exports = {
  ...
  down: (queryInterface, Sequelize) => {
    return queryInterface.sequelize.transaction(transaction => {
      return Promise.all([
        queryInterface.removeColumn("Events", "attendees_can_edit", { transaction }),
        queryInterface.removeColumn("Events", "invite_required", { transaction }),
        queryInterface.removeColumn("Events", "user_can_join", { transaction })
      ]);
    });
  }
};
